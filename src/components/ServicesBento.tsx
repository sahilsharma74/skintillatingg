  ...
  return (
    <section className="py-20 sm:py-28 md:py-32 bg-[#657A6A] text-[#F5F5DC] border-b border-[#AEB9A9]/30">
      <div className="max-w-[1440px] mx-auto px-6 sm:px-10 md:px-16 lg:px-20">
        {/* Section Header */}
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-14 gap-6 border-b border-[#AEB9A9]/30 pb-8">
          <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
          {services.map((service, idx) => (
            <div
              key={idx}
              className="bg-[#F5F5DC] text-[#17251E] p-6 sm:p-8 rounded-sm border border-[#AEB9A9]/40 flex flex-col justify-between group hover:border-[#17251E]/40 transition-all duration-300 shadow-md h-full"
            >
              <div className="flex flex-col flex-grow">
                {/* Horizontal Video/Image Frame (Preserves exact aspect ratio) */}
                <div className="w-full aspect-[16/10] mb-6 overflow-hidden rounded-sm border border-[#17251E]/15 relative bg-[#17251E] shadow-inner">
              ...
              <div className="pt-4 border-t border-[#17251E]/15 flex items-center justify-between">
                <Link
                  ...
                  className="font-button text-[11px] tracking-[0.15em] uppercase text-[#17251E] font-semibold flex items-center gap-2 hover:text-[#C9A227] transition-colors"
                >
                  <span>INQUIRE</span>
